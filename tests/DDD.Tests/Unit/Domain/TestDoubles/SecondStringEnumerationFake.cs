...
public class SecondStringEnumerationFake : Enumeration<string?, SecondStringEnumerationFake>
{
    ...
    public static readonly SecondStringEnumerationFake Zero = new(null);
    public static readonly SecondStringEnumerationFake One = new(nameof(One));
    public static readonly SecondStringEnumerationFake Two = new(nameof(Two));
    public static readonly SecondStringEnumerationFake Three = new(nameof(Three));

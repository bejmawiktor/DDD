        ...
        public static IEnumerable<TestCaseData> EqualsOperatorTestData
        {
            get
            {
                yield return new TestCaseData(new object[]
                {
                    ...
                    new ThirdValueObjectFake(1, 3.1, "AAB"),
                    true
                }).SetName($"{nameof(TestEqualsOperator_WhenValueObjectGiven_ThenMembersAreComapred)}(1)");
                yield return new TestCaseData(new object[]
                {
                    new ThirdValueObjectFake(2, 3.4, "AAC"),
                    new ThirdValueObjectFake(2, 3.4, "AAC"),
                    true
                }).SetName($"{nameof(TestEqualsOperator_WhenValueObjectGiven_ThenMembersAreComapred)}(2)");
                yield return new TestCaseData(new object[]
                {
                    new ThirdValueObjectFake(2, 3.5, "AAC"),
                    new ThirdValueObjectFake(2, 3.5, "AAC"),
                    true
                }).SetName($"{nameof(TestEqualsOperator_WhenValueObjectGiven_ThenMembersAreComapred)}(3)");
                yield return new TestCaseData(new object[]
                {
                    new ThirdValueObjectFake(2, 3.1, "AAB"),
                    new ThirdValueObjectFake(2, 3.1, "AAB"),
                    true
                }).SetName($"{nameof(TestEqualsOperator_WhenValueObjectGiven_ThenMembersAreComapred)}(4)");
                yield return new TestCaseData(new object[]
                {
                    new ThirdValueObjectFake(1, 3.1, "AAB"),
                    new ThirdValueObjectFake(1, 3.2, "AAB"),
                    false
                }).SetName($"{nameof(TestEqualsOperator_WhenValueObjectGiven_ThenMembersAreComapred)}(5)");
                yield return new TestCaseData(new object[]
                {
                    new ThirdValueObjectFake(3, 3.5, "AAC"),
                    new ThirdValueObjectFake(2, 3.4, "AAC"),
                    false
                }).SetName($"{nameof(TestEqualsOperator_WhenValueObjectGiven_ThenMembersAreComapred)}(6)");
                yield return new TestCaseData(new object[]
                {
                ...
                yield return new TestCaseData(new object[]
                {
                    ...
                    null,
                    true
                }).SetName($"{nameof(TestEqualsOperator_WhenValueObjectGiven_ThenMembersAreComapred)}(10)");
            }
        }
        ...
        public static IEnumerable<TestCaseData> NotEqualsOperatorTestData
        {
            get
            {
                yield return new TestCaseData(new object[]
                {
                    ...
                    new ThirdValueObjectFake(1, 3.1, "AAB"),
                    false
                }).SetName($"{nameof(TestNotEqualsOperator_WhenValueObjectGiven_ThenMembersAreComapred)}(1)");
                yield return new TestCaseData(new object[]
                {
                    new ThirdValueObjectFake(2, 3.4, "AAC"),
                    new ThirdValueObjectFake(2, 3.4, "AAC"),
                    false
                }).SetName($"{nameof(TestNotEqualsOperator_WhenValueObjectGiven_ThenMembersAreComapred)}(2)");
                yield return new TestCaseData(new object[]
                {
                    new ThirdValueObjectFake(2, 3.5, "AAC"),
                    new ThirdValueObjectFake(2, 3.5, "AAC"),
                    false
                }).SetName($"{nameof(TestNotEqualsOperator_WhenValueObjectGiven_ThenMembersAreComapred)}(3)");
                yield return new TestCaseData(new object[]
                {
                    new ThirdValueObjectFake(2, 3.1, "AAB"),
                    new ThirdValueObjectFake(2, 3.1, "AAB"),
                    false
                }).SetName($"{nameof(TestNotEqualsOperator_WhenValueObjectGiven_ThenMembersAreComapred)}(4)");
                yield return new TestCaseData(new object[]
                {
                    new ThirdValueObjectFake(1, 3.1, "AAB"),
                    new ThirdValueObjectFake(1, 3.2, "AAB"),
                    true
                }).SetName($"{nameof(TestNotEqualsOperator_WhenValueObjectGiven_ThenMembersAreComapred)}(5)");
                yield return new TestCaseData(new object[]
                {
                    new ThirdValueObjectFake(3, 3.5, "AAC"),
                    new ThirdValueObjectFake(2, 3.4, "AAC"),
                    true
                }).SetName($"{nameof(TestNotEqualsOperator_WhenValueObjectGiven_ThenMembersAreComapred)}(6)");
                yield return new TestCaseData(new object[]
                {
                    new ThirdValueObjectFake(3, 3.4, "AAD"),
                    new ThirdValueObjectFake(2, 3.5, "AAC"),
                ...
                yield return new TestCaseData(new object[]
                {
                    ...
                    null,
                    false
                }).SetName($"{nameof(TestNotEqualsOperator_WhenValueObjectGiven_ThenMembersAreComapred)}(10)");
            }
        }
        ...
        public static IEnumerable<TestCaseData> GetHashCodeTestData
        {
            get
            {
                yield return new TestCaseData(new object[]
                {
                    ...
                    new FirstValueObjectFake(1, "AA"),
                    true
                }).SetName($"{nameof(TestGetHashCode_WhenTwoValueObjectHaveSameMembers_ThenSameHashCodesAreReturned)}(1)");
                yield return new TestCaseData(new object[]
                {
                    new FirstValueObjectFake(2, "AAB"),
                    new FirstValueObjectFake(2, "AAB"),

...
namespace  DDD.Tests.Unit.Domain.Model
{
    ...
    public class EnumerationTest
    {
        ...
        public static IEnumerable<TestCaseData> EqualsOperatorTestData
        {
            get
            {
                yield return new TestCaseData(new object[]
                {
                    ...
                    FirstStringEnumerationFake.One,
                    true
                }).SetName($"{nameof(TestEqualsOperator_WhenEnumerationsGiven_ThenValuesAreCompared)}(1)");
                yield return new TestCaseData(new object[]
                {
                    FirstStringEnumerationFake.Two,
                    FirstStringEnumerationFake.Two,
                    true
                }).SetName($"{nameof(TestEqualsOperator_WhenEnumerationsGiven_ThenValuesAreCompared)}(2)");
                yield return new TestCaseData(new object[]
                {
                    FirstStringEnumerationFake.Three,
                    FirstStringEnumerationFake.Three,
                    true
                }).SetName($"{nameof(TestEqualsOperator_WhenEnumerationsGiven_ThenValuesAreCompared)}(3)");
                yield return new TestCaseData(new object[]
                {
                    FirstStringEnumerationFake.Zero,
                    FirstStringEnumerationFake.Zero,
                ...
                yield return new TestCaseData(new object[]
                {
                    ...
                    null,
                    false
                }).SetName($"{nameof(TestEqualsOperator_WhenEnumerationsGiven_ThenValuesAreCompared)}(6)");
                yield return new TestCaseData(new object[]
                {
                    FirstStringEnumerationFake.Two,
                    FirstStringEnumerationFake.Three,
                    false
                }).SetName($"{nameof(TestEqualsOperator_WhenEnumerationsGiven_ThenValuesAreCompared)}(7)");
                yield return new TestCaseData(new object[]
                {
                    FirstStringEnumerationFake.Zero,
                    FirstStringEnumerationFake.Three,
                    false
                }).SetName($"{nameof(TestEqualsOperator_WhenEnumerationsGiven_ThenValuesAreCompared)}(8)");
                yield return new TestCaseData(new object[]
                {
                    FirstStringEnumerationFake.Three,
                    FirstStringEnumerationFake.Zero,
                    false
                }).SetName($"{nameof(TestEqualsOperator_WhenEnumerationsGiven_ThenValuesAreCompared)}(9)");
            }
        }
        ...
        public static IEnumerable<TestCaseData> NotEqualsOperatorTestData
        {
            get
            {
                yield return new TestCaseData(new object[]
                {
                    ...
                    FirstStringEnumerationFake.One,
                    false
                }).SetName($"{nameof(TestNotEqualsOperator_WhenEnumerationsGiven_ThenValuesAreCompared)}(1)");
                yield return new TestCaseData(new object[]
                {
                    FirstStringEnumerationFake.Two,
                    FirstStringEnumerationFake.Two,
                    false
                }).SetName($"{nameof(TestNotEqualsOperator_WhenEnumerationsGiven_ThenValuesAreCompared)}(2)");
                yield return new TestCaseData(new object[]
                {
                    FirstStringEnumerationFake.Three,
                    FirstStringEnumerationFake.Three,
                    false
                }).SetName($"{nameof(TestNotEqualsOperator_WhenEnumerationsGiven_ThenValuesAreCompared)}(3)");
                yield return new TestCaseData(new object[]
                {
                    FirstStringEnumerationFake.Zero,
                    FirstStringEnumerationFake.Zero,
                ...
                yield return new TestCaseData(new object[]
                {
                    ...
                    null,
                    true
                }).SetName($"{nameof(TestNotEqualsOperator_WhenEnumerationsGiven_ThenValuesAreCompared)}(6)");
                yield return new TestCaseData(new object[]
                {
                    FirstStringEnumerationFake.Two,
                    FirstStringEnumerationFake.Three,
                    true
                }).SetName($"{nameof(TestNotEqualsOperator_WhenEnumerationsGiven_ThenValuesAreCompared)}(7)");
                yield return new TestCaseData(new object[]
                {
                    FirstStringEnumerationFake.Zero,
                    FirstStringEnumerationFake.Three,
                    true
                }).SetName($"{nameof(TestNotEqualsOperator_WhenEnumerationsGiven_ThenValuesAreCompared)}(8)");
                yield return new TestCaseData(new object[]
                {
                    FirstStringEnumerationFake.Three,
                    FirstStringEnumerationFake.Zero,
                    true
                }).SetName($"{nameof(TestNotEqualsOperator_WhenEnumerationsGiven_ThenValuesAreCompared)}(9)");
            }
        }
        ...
        public static IEnumerable<TestCaseData> GetHashCodeTestData
        {
            get
            {
                yield return new TestCaseData(new object[]
                {
                    ...
                    FirstStringEnumerationFake.Zero,
                    true
                }).SetName($"{nameof(TestGetHashCode_WhenTwoEntitiesHaveSameValues_ThenSameHashCodesAreReturned)}(1)");
                yield return new TestCaseData(new object[]
                {
                    FirstStringEnumerationFake.One,
                    FirstStringEnumerationFake.One,
        ...
        {
            Assert.That(FirstStringEnumerationFake.CollateNull(null), Is.EqualTo(FirstStringEnumerationFake.Default));
        }

        [Test]
        public void TestCollateNull_WhenEnumerationGiven_ThenGivenEnumerationIsReturned()
        {
            Assert.That(FirstStringEnumerationFake.CollateNull(FirstStringEnumerationFake.One), Is.EqualTo(FirstStringEnumerationFake.One));
        }
        ...
        public void TestCastingFromValueToEnumeration_WhenNotRecognizedValueGiven_ThenArgumentExceptionIsThrown()
        {
            Assert.Throws(
                Is.InstanceOf<ArgumentException>()
                    .And.Message
                    .EqualTo($"Wrong {nameof(FirstStringEnumerationFake)} value."),

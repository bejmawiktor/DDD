...
namespace DDD.Domain.Model
{
    ...
    : Identifier<TTupleKeys, TDeriviedCompositeIdentifier>
        ...
        where TDeriviedCompositeIdentifier : CompositeIdentifier<TTupleKeys, TDeriviedCompositeIdentifier>
    {
        protected CompositeIdentifier(TTupleKeys value) : base(value)
        {
        }
    }
}